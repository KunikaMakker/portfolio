                        ...
                        >
                            ...
                            <div className="h-52 overflow-hidden relative">
                                <img
                                    src={dest.image}
                                    alt={dest.place}
                                    className={`w-full h-full object-cover ${dest.position} md:group-hover:scale-105 transition-transform duration-700`}
                                />
                                {/* subtle dark overlay for readability */}
                                <div className="absolute inset-0 bg-foreground/20 md:group-hover:bg-foreground/10 transition-colors duration-500" />
                            </div>
